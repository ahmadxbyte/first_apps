...
class M_cabang_list extends CI_Model
{
    private $table = 'user';
    private $order = ['u.id', 'u.kode_user', 'u.nama', 'u.email'];
    private $kolom = ['u.id', 'u.kode_user', 'u.nama', 'u.email'];
    private $search = ['u.id', 'u.kode_user', 'u.nama', 'u.email'];
