                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="norek" class="control-label text-danger">No Rekening</label>
                                        <input type="text" class="form-control" id="norek" name="norek" placeholder="Masukkan No Rekening">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table shadow-sm table-hover table-bordered" id="tableBank" width="100%" style="border-radius: 10px;">
                                    <thead>
...
<script>
    ...
    function save() {
        ...
        if (norek.val() == '' || norek.val() == null) { // jika norek null/ kosong
            btnSimpan.attr('disabled', false);

            return Swal.fire("No Rekening", "Form sudah diisi?", "question");
        }
