                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="jenis" class="control-label text-danger">Jenis Ruangan</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table shadow-sm table-hover table-bordered" id="tableRuang" width="100%" style="border-radius: 10px;">
                                    <thead>
