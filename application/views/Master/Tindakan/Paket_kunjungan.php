...
<form method="post" id="form_tindakan_paket_kunjungan">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary" <?= $style ?>>
                <div class="card-header">
                    <span class="font-weight-bold h4"><i class="fa-solid fa-bookmark text-primary"></i> Daftar Tindakan Paket Kunjungan</span>
                    <div class="float-right">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#" onclick="preview('tindakan_paket_kunjungan')"><i class="fa-solid fa-fw fa-tv"></i>&nbsp;&nbsp;Preview</a></li>
                                <li><a class="dropdown-item" href="#" onclick="print('tindakan_paket_kunjungan')"><i class="fa-regular fa-fw fa-file-pdf"></i>&nbsp;&nbsp;Pdf</a></li>
                                <li><a class="dropdown-item" href="#" onclick="excel('tindakan_paket_kunjungan')"><i class="fa-regular fa-fw fa-file-excel"></i>&nbsp;&nbsp;Excel</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table shadow-sm table-hover table-bordered" id="tableTindakanPaketKunjungan" width="100%" style="border-radius: 10px;">
                                    <thead>
...
<script>
    var table = $('#tableTindakanPaketKunjungan');

    function assign(kode_tindakan) {
        getUrl('Master/form_tindakan_paket_kunjungan/' + kode_tindakan);
    }
    ...
    function showGuide() {
        ...
        // isi text
        $('#modal_mgLabel').append(`Manual Guide Master Tarif Paket Kunjungan`);
        $('#modal-isi').append(`
            <ol>
