                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <select name="kodeTarif" id="kodeTarif" class="select2_tarif_paketx form-control" data-placeholder="~ Pilih Tarif Paket" onchange="getTarif(this.value)">
                                                <?php if (!empty($tarif)) : ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_kategori" style="width: 100%;">
...
<script>
    ...
    function reseting() {
        ...
        jenis_bayar.html(`<option value="">~ Pilih Jenis Bayar</option>`);
        $('#jumJasa').val(0);
        bodyDetail.empty();
        $('#jumBhp').val(0);
        bodyBhp.empty();
