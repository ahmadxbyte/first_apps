...
<script>
    ...
    function ubah(kode_tarif, bayar, kelas) {
        getUrl('Master/form_tin_single/' + kode_tarif + '/' + bayar + '/' + kelas);
    }

    // fungsi hapus berdasarkan kode_supplier
    function hapus(kode_tarif, bayar, kelas) {
        // ajukan pertanyaaan
        Swal.fire({
            title: "Kamu yakin?",
            ...
            if (result.isConfirmed) { // jika yakin
                ...
                // jalankan fungsi
                $.ajax({
                    url: siteUrl + 'Master/delTarifSingle/' + kode_tarif + '/' + bayar + '/' + kelas,
                    type: 'POST',
                    dataType: 'JSON',
